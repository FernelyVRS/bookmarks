...
const Links = () => {
	...
	return (
		<div className="h-screen bg-gray-900">
			<div>
				<h1 className="text-3xl text-center font-bold text-white pt-8 ">
					Bookmarks
				</h1>
			</div>
			<div className="grid grid-cols-12">
				<div className="col-span-12 md:col-span-6 bg-gray-900  ">
				...
				<div className="col-span-12 md:col-span-6">
					<div className=" bg-gray-900 py-6 mx-auto ">
						<div className="flex flex-auto flex-wrap px-2">
							{links.map((link) => (
								<div className="w-full md:px-4  lg:px-6 py-5" key={link.id}>
									<div className=" bg-gray-800 rounded-xl shadow-lg ">
										<div className="px-4 py-4 md:px-10">
											<div className="flex">
												...
												<div className="mx-1">
													<i
														className="material-icons text-blue-50 hover:text-blue-800 cursor-pointer"
												...
												<div className="mx-1">
													<i
														className="material-icons text-blue-50 hover:text-red-800 cursor-pointer"
